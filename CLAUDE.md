...
`cmd/generate-tap-man-completions.rb` (`brew generate-tap-man-completions`).
...
`brew generate-tap-man-completions` and committing the result. CI verifies these and man page
sources are current.
