...
__fish_brew_complete_arg 'man' -l html -d 'Render the man page as HTML and open it in a browser'
...
__fish_brew_complete_arg 'man' -l select -d 'Interactively select which copy of the man page to view with `fzf`'
